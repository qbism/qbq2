...
/* qbism runandshoot was never used
...
void GunnerFire (edict_t *self)
{
	...
	flash_number = MZ2_GUNNER_MACHINEGUN_1 + (self->s.frame - FRAME_attak208); //qbism was 216
...
mmove_t gunner_move_attack_chain = {FRAME_attak201, FRAME_attak207, gunner_frames_attack_chain, gunner_fire_chain};
//qbism was 209, 215
