...
//qbism: remove pragmas #ifdef _WIN32
// unknown pragmas are SUPPOSED to be ignored, but....
////qbism remove #pragma warning(disable : 4244)     // MIPS
////qbism remove #pragma warning(disable : 4136)     // X86
////qbism remove #pragma warning(disable : 4051)     // ALPHA

////qbism remove #pragma warning(disable : 4018)     // signed/unsigned mismatch
////qbism remove #pragma warning(disable : 4305)		// truncation from const double to float
...
// from Quake3 source
#ifdef WIN32
#define Q_vsnprintf _vsnprintf  //qb: define this
...
//qb:  deactivate kmq2.  Maybe add some features to SW engine later.	#define	KMQUAKE2_ENGINE_MOD
...
#define	MAX_EDICTS			4096	//qb:  was 1024.
